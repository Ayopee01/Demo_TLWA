    ...
    return (
        <div className="flex justify-start my-2">
            <div className="flex border border-indigo-200 rounded-full overflow-hidden shadow-sm ml-2 mb-10">
                <button
                    className={`cursor-pointer px-5 py-2 text-base font-semibold transition ${lang === "th"
                ...
                <button
                    className={`cursor-pointer px-5 py-2 text-base font-semibold transition ${lang === "en"
                            ? "bg-indigo-500 text-white"
                            : "text-indigo-500 bg-white hover:bg-indigo-50"
                        }`}
                    onClick={() => setLang("en")}
        ...
        >
            ...
            <div className="flex justify-center">
                <div className="inline-flex rounded-full bg-white/5 p-1 border border-white/10">
                    <button
                        onClick={() => setTier("T2")}
                        className={`cursor-pointer px-5 py-2 text-sm font-semibold rounded-full transition ${tier === "T2" ? "bg-white text-gray-900" : "text-white/80 hover:text-white"
                            }`}
                    >
                        Tier 2
                    </button>
                    <button
                        onClick={() => setTier("T3")}
                        className={`cursor-pointer px-5 py-2 text-sm font-semibold rounded-full transition ${tier === "T3" ? "bg-white text-gray-900" : "text-white/80 hover:text-white"
                            }`}
                    >
                        Tier 3
                    </button>
